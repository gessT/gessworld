                    ...
                    <div className="border-t border-white/8 pt-4 space-y-3">
                      ...
                      <div className="flex flex-col gap-2">
                        <a
                          ...
                          className={`w-full inline-flex items-center justify-center gap-2.5 rounded-xl py-4 px-5 text-[11px] font-black uppercase tracking-[0.22em] transition-all duration-300 active:scale-[0.97] ${
                            hasSelected
                              ? "bg-[#25D366] text-white shadow-[0_4px_24px_rgba(37,211,102,0.35)] hover:bg-[#1db954] hover:shadow-[0_4px_36px_rgba(37,211,102,0.55)]"
                              : "bg-white/[0.06] text-white/50 border border-white/10 hover:bg-[#25D366] hover:text-white hover:border-transparent hover:shadow-[0_4px_24px_rgba(37,211,102,0.4)]"
                          }`}
                        >
                        ...
                        <Link
                          href="/travel"
                          className="w-full inline-flex items-center justify-center gap-1.5 rounded-xl py-3 px-5 text-[11px] font-black uppercase tracking-[0.2em] text-white/40 border border-white/8 transition-all duration-200 hover:text-red-400 hover:border-red-400/30 hover:bg-red-500/5 active:scale-[0.97]"
                        >
